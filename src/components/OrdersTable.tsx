            ...
            <div className="bg-black text-white px-8 py-4 rounded-3xl shadow-2xl flex items-center gap-8 backdrop-blur-xl border border-white/10">
              ...
              <div className="flex items-center gap-3">
                ...
                <PlasticButton
                  ...
                  className="h-7 px-3 text-[9px] font-bold uppercase tracking-widest bg-gradient-to-b from-red-500 to-red-600 text-white hover:from-red-400 hover:to-red-500 shadow-[0_4px_20px_-4px_rgba(239,68,68,0.4)]"
                />
                <PlasticButton
                  ...
                  className="h-7 px-3 text-[9px] font-bold uppercase tracking-widest bg-gradient-to-b from-white to-zinc-300 !text-black shadow-[0_4px_20px_-4px_rgba(255,255,255,0.2)]"
                />
                <PlasticButton
                  text="Generate Invoice"
                  icon={FileText}
                  onClick={handleGenerateInvoice}
                  className="h-7 px-3 text-[9px] font-bold uppercase tracking-widest bg-white/10 text-white hover:bg-white/20 border border-white/10"
                />
                <PlasticButton
                  text="Print"
                  icon={Printer}
