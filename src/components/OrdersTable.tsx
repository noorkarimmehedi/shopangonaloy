                    ...
                    <div className="flex items-center justify-center gap-2">
                      {!order.sent_to_courier ? (
                        <PlasticButton
                          ...
                          className="h-7 px-3 text-[6px] font-bold uppercase tracking-widest bg-gradient-to-b from-blue-500 to-blue-600 hover:from-blue-400 hover:to-blue-500 shadow-lg shadow-blue-500/20 whitespace-nowrap"
                        />
                      ) : (
